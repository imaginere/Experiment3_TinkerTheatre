...
int buttonPin = 4;
int analogInPin = A1;
int analogInPinThree = A2;
int analogInPinTwo = A0;
int analogInPinFour = A3;
...

{
  ...
  int anaValueTwo = analogRead(analogInPinTwo);           //read the analog value
  int anaValueThree = analogRead(analogInPinThree);       //read the analog value
  int anaValueFour = analogRead(analogInPinFour);       //read the analog value
...
////////////////////////////////////////////////////////////send the values to P5 over serial
  ...
  p5Send["s3"]=anaValueTwo;                               //assign anaValue to the key "s3" in the json object 
  p5Send["s4"]=anaValueThree;                             //assign anaValue to the key "s4" in the json object
  p5Send["s5"]=anaValueFour;                             //assign anaValue to the key "s5" in the json object 
